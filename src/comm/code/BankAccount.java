...
public abstract class BankAccount {
	protected static int numberOfAccounts = 100001;			// current balance in the account
	private double balance;									// name on the account
	private String owner;									// number bank uses to identify account
